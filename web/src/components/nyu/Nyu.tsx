 ...
 * Nyu, the padlock cat.
 *
 * Same cat as in UwUMail, UwUSSH and UwURDP — her hull is a padlock here: the
 * shackle arches up between the ears, a keyhole sits on her forehead, and the
 * plate on the lock body is the face. Plate, eyes, mouth and blush sit exactly
 * where they did, so every mood and scene fits.
 *
 ...
 * shackle arches above it, up to 11).
 */
