...
const PATHS = {
  ...
  eyeOff:
    'M3.5 4.5l17 15 M9.9 6a9.8 9.8 0 0 1 2.1-.5c6 0 9.5 6.5 9.5 6.5a17 17 0 0 1-2.6 3.5 M14.1 17.9a9.4 9.4 0 0 1-2.1.6c-6 0-9.5-6.5-9.5-6.5a17 17 0 0 1 3.4-4.2 M10.2 10.3a2.5 2.5 0 0 0 3.5 3.5',
  globe:
    'M12 20.5a8.5 8.5 0 1 0 0-17 8.5 8.5 0 0 0 0 17Z M3.5 12h17 M12 3.5c2.3 2.3 3.4 5.2 3.4 8.5s-1.1 6.2-3.4 8.5c-2.3-2.3-3.4-5.2-3.4-8.5S9.7 5.8 12 3.5Z',
  card: 'M3.5 6h17v12h-17z M3.5 10h17 M7 14.5h4',
  id: 'M3.5 5.5h17v13h-17z M9 11.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z M5.8 15.8a3.3 3.3 0 0 1 6.4 0 M14.5 9.5h3 M14.5 13h3',
  note: 'M6 3.5h9l3 3V20.5H6z M9 9h6 M9 12.5h6 M9 16h4',
  star: 'M12 4l2.4 5 5.4.6-4 3.7 1.1 5.4L12 16l-4.9 2.7 1.1-5.4-4-3.7 5.4-.6Z',
  external: 'M14 4.5h5.5V10 M19.5 4.5 11 13 M17 13.5V19H5V7h5.5',
  search: 'M10.5 17a6.5 6.5 0 1 0 0-13 6.5 6.5 0 0 0 0 13Z M15.3 15.3 20 20',
  dice: 'M4.5 4.5h15v15h-15z M9 9h.01 M15 9h.01 M12 12h.01 M9 15h.01 M15 15h.01',
  logout: 'M14 4.5H5v15h9 M10 12h10 M16.5 8.5 20 12l-3.5 3.5',
  layers: 'M12 4 3.5 8.5 12 13l8.5-4.5Z M3.5 12.5 12 17l8.5-4.5 M3.5 16.5 12 21l8.5-4.5',
  building: 'M5 20.5V4.5h9v16 M14 9.5h5v11 M3.5 20.5h17 M8 8h3 M8 11.5h3 M8 15h3',
  clock: 'M12 20.5a8.5 8.5 0 1 0 0-17 8.5 8.5 0 0 0 0 17Z M12 7.5V12l3 2',
  history: 'M4 12a8 8 0 1 0 2.3-5.6 M4 4.5v3.5h3.5 M12 8v4.5l3 1.5',
  warning: 'M12 4 21 19.5H3Z M12 10v4.5 M12 17h.01',
} as const;
